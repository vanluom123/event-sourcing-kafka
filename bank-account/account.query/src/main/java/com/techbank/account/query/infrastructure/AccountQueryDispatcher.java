...
public class AccountQueryDispatcher implements QueryDispatcher {
  ...
  @Override
  public void registerHandler(Class<? extends BaseQuery> type,
                              QueryHandlerMethod<? extends BaseQuery> handler) {
  ...
  public List<BaseEntity> send(BaseQuery query) {
    ...
    QueryHandlerMethod<BaseQuery> queryHandlerMethod = (QueryHandlerMethod<BaseQuery>) handlers.get(0);
    return queryHandlerMethod.handle(query);
  }
}
